...
import com.hotelbooking.backend.Service.AwsS3Service;
import com.hotelbooking.backend.Service.interfaces.IRoomService;
	...
	public Response updateRoom(Long roomId, String description, String roomType, BigDecimal roomPrice, MultipartFile photo) {
		 Response response = new Response();
	        ...
	        try {
	            ...
	            if (imageUrl != null) room.setPhoto(imageUrl);
